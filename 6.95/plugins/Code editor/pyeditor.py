...
from PyQt5.QtWidgets import QMainWindow, QDialog, QMessageBox, QDesktopWidget, QWidget, QPlainTextEdit, QPushButton, QLineEdit, QApplication
from PyQt5.QtCore import pyqtSignal, pyqtSlot, QObject, QEvent, QTextStream
